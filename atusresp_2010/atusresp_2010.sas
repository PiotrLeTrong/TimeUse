...
*;
data atusresp_2010;
infile "c:\atusresp_2010.dat" firstobs=2 dsd missover lrecl=16384 dlm=",";
length
 TUCASEID $14
 TULINENO 8
 TUYEAR 8 
...
label TRERNHLY = "Hourly earnings (2 implied decimals)";
...
;
proc contents data=atusresp_2010; run;
